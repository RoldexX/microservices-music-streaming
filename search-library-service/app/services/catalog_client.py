...
class CatalogClient:
    """
    Синхронный клиент к catalog-service (порт 8002).
    Используется для проверки существования трека перед добавлением в плейлист.
    """
    ...
    def get_track(self, track_id: str) -> Dict[str, Any] | None:
        ...
        try:
            ...
            # В учебном примере: считаем, что при ошибке трек "не найден"
            return None
